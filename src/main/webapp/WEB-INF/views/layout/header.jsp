    ...
    <header class="header">
        <div class="header-container">
            ...
            <div class="actions">
                ...
                <ul class="nav">
                  <li class="nav-item">
                    <c:if test="${empty sMid}"><a href="#" class="nav-link login" style="padding-left: 0 !important; padding-right: 0 !important;"><i class="fas fa-user"></i></a></c:if>
                    <c:if test="${!empty sMid}"><a href="${ctp}/common/myPage" class="nav-link" style="padding-left: 0 !important; padding-right: 0 !important;"><i class="fas fa-user"></i></a></c:if>
                    <ul class="myPage">
