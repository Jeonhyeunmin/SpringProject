  ...
  <c:if test="${!empty vos}">
	  <div class="button-group">
	  	<ul class="button-group-ul">
				<li><button type="button" onclick="location.href='">많이팔린순</button></li>
				<li><button type="button" onclick="location.href='">최근등록순</button></li>
				<li><button type="button" onclick="location.href='">낮은가격순</button></li>
				<li><button type="button" onclick="location.href=''">높은가격순</button></li>
				<li><button type="button" onclick="location.href='">상품평개수순</button></li>
	  	</ul>
		</div>
